// https://github.com/yuanqing/create-figma-plugin/blob/cb6879f4602f97f268ed0bbab461927b7e34bd88/packages/utilities/src/events.ts#L50
...
export const emit = function <Handler extends EventHandler>(
  name: Handler['name'],
